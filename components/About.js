...
const About = () => {
	return (
		<div>
			<section class="bg-blue-200 py-20 mt-20 lg:mt-60 rounded-lg mb-12">
				<div class="sm:w-3/4 lg:w-5/12 mx-auto px-2">
					<h1 class="text-4xl text-center font-bold text-blue-500">Tentang Saya</h1>
					<p class="text-blue-500 text-center mt-4">
